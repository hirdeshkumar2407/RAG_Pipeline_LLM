...
## 🧠 Project Mission
As part of the Natural Language Processing course at Politecnico di Milano, our team—Red Chilli Models—embarked on a challenging and rewarding mission: to build a full-scale, end-to-end Retrieval-Augmented Generation (RAG) pipeline.
Our goal was to go beyond a simple proof-of-concept. We conducted a deep dive into the RAG-Instruct dataset (~40,000 QA pairs), performing in-depth data analysis, benchmarking multiple LLMs, and fine-tuning a FLAN-T5 model. As the project owner and a key contributor, I guided our team's strategy to explore advanced techniques, from two-stage retrieval systems to experimental multi-step generation with voting.
This document details the architecture, methods, and findings of our comprehensive exploration into the world of modern, context-aware AI.

## 🤝 The Red Chilli Models Team
